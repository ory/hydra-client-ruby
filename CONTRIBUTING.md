...
# Contribute to Ory Ory Hydra Ruby Client<!-- omit in toc -->
...
Ory Hydra Ruby Client's direction. A great way to
do this is via
...
- **Help with open issues.** We have a lot of open issues for Ory Ory Hydra Ruby Client and
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/hydra-client-ruby/blob/master/.github/workflows/conventional_commits.yml)
