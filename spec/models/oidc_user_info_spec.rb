...
# Unit tests for OryHydraClient::OidcUserInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryHydraClient::OidcUserInfo do
  #let(:instance) { OryHydraClient::OidcUserInfo.new }

  describe 'test an instance of OidcUserInfo' do
    it 'should create an instance of OidcUserInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OryHydraClient::OidcUserInfo)
    end
  end
